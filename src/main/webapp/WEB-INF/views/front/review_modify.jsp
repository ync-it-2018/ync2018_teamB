				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="/">
							<img src="/resources/front/images/home/logo.png"alt="" /></a>
						</div>
...
<%-- 							<form role="form" method="post">
								<input type='hidden' name='REVIEW_NUM' value="${review_modify.REVIEW_NUM}">
							</form> --%>
							<table class="freeboard">
								...
								<tbody>
									<tr>
										<th>제목</th>
										<td>
										<input type="text" name="REVIEW_TITLE" id="REVIEW_TITLE" style="width: 1004px; height: 30px;" value="${review_modify.REVIEW_TITLE}">
											</td>
									</tr>
									<tr>
										<th style="vertical-align:center; ">내용</th>
										<td bgcolor="white">
										    <textarea name="REVIEW_CONT" id="contents" rows="10" cols="100" style="width:766px; height:412px;">${review_modify.REVIEW_CONT}</textarea>
										</td>
									</tr>
								</tbody>
							</table>						
							...
							<input name="REVIEW_GRADE" id="input-21e"  type="number" class="rating" min=0 max=5 step=0.5 data-size="sm"value="${review_modify.REVIEW_GRADE}" ></div>
							<div style="float:right; display:inline-block; width:600px; height:100px; ">
							<%-- <input type='hidden' name='REVIEW_CONT' value="${review_modify.REVIEW_NUM}"> --%>
							<!-- <input type="button" id="savebutton" value="서버전송" /> -->
							<button id="savebutton" >글 수정</button>
							</div>
						</div>
					</div>
				</div>
