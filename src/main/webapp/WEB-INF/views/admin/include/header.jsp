...
<html>
  ...
  <!-- 어드민 페이지 헤더 부분 디자인  -->
    <meta charset="UTF-8">
    <title>TeamB Project Admin Page</title>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/reviewsearch"><i class="fa fa-circle-o"></i> 사용후기 목록</a></li>
                <li><a href="/reviewment"><i class="fa fa-circle-o"></i> 사용후기 조회/수정</a></li>
              </ul>
            </li>
            <li>
              <a href="/product_registration">
                <i class="fa fa-th"></i> <span>제품 등록</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
            </li>
